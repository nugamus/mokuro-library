...
INSERT INTO "new_Series" ("coverPath", "createdAt", "description", "folderName", "id", "lastReadAt", "ownerId", "sortTitle", "title", "updatedAt") SELECT "coverPath", "createdAt", "description", "folderName", "id", "lastReadAt", "ownerId", "sortTitle", "title", "updatedAt" FROM "Series";
DROP TABLE "Series";
