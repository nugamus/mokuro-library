...
INSERT INTO "new_Series" ("bookmarked", "coverPath", "createdAt", "description", "folderName", "id", "japaneseTitle", "lastReadAt", "ownerId", "romajiTitle", "sortTitle", "status", "synonyms", "title", "updatedAt") SELECT "bookmarked", "coverPath", "createdAt", "description", "folderName", "id", "japaneseTitle", "lastReadAt", "ownerId", "romajiTitle", "sortTitle", "status", "synonyms", "title", "updatedAt" FROM "Series";
DROP TABLE "Series";
