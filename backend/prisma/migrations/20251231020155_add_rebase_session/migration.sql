/*
  ...
  - You are about to drop the column `isFloating` on the `OcrBranch` table. All the data in the column will be lost.

*/
-- CreateTable
CREATE TABLE "RebaseSession" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "branchId" TEXT NOT NULL,
    "targetHeadPatchId" TEXT NOT NULL,
    "headPatchIdSnapshot" TEXT NOT NULL,
    "resolutions" TEXT NOT NULL DEFAULT '[]',
    "updatedAt" DATETIME NOT NULL,
    "expiresAt" DATETIME NOT NULL,
    CONSTRAINT "RebaseSession_branchId_fkey" FOREIGN KEY ("branchId") REFERENCES "OcrBranch" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "RebaseSession_targetHeadPatchId_fkey" FOREIGN KEY ("targetHeadPatchId") REFERENCES "Patch" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "RebaseSession_headPatchIdSnapshot_fkey" FOREIGN KEY ("headPatchIdSnapshot") REFERENCES "Patch" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE UNIQUE INDEX "RebaseSession_branchId_key" ON "RebaseSession"("branchId");
