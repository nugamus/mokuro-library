	...
	<MenuGrid items={menuItems} {layout}>
		{#snippet children(itemKey)}
			...
			{:else if itemKey === 'select'}
				...
				>
					{#snippet icon()}{@render iconSelect()}{/snippet}
				</MenuGridItem>
			{/if}
		{/snippet}
	</MenuGrid>
	...
	<MenuGroup>
		...
		>
			{#snippet icon()}
				...
				>
					<path
						d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 
					2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"
					/>
		...
		<MenuItem
			...
			onClick={() => {
				// Discord link to be implemented
				contextMenu.close();
			}}
			className="rounded-xl"
		>
