	...
	themes = $state<Theme[]>([
		{
			...
			colors: {
				...
				light: {
					'main-background': '#334155', // slate-700 - lighter than dark but maintains slate character
					'card-background': '#475569', // slate-600 - lighter slate for cards
					'card-highlight': '#64748b', // slate-500 - hover state
					'border-color': '#64748b', // slate-500 - visible borders
					'primary-color': '#6366f1', // indigo-500 - same vibrant indigo
					'primary-hover': '#818cf8', // indigo-400 - lighter hover for light mode
					'main-text': '#f1f5f9', // slate-100 - light text for contrast
					'muted-text': '#cbd5e1', // slate-300 - lighter muted text
					'reading-color': '#6366f1' // indigo-500 - same accent
				}
			}
		},
		{
			...
			previewColors: {
				...
				light: ['#5b5f7d', '#6e738d', '#8b8fa8', '#1e66f5', '#8b8fa8'] // lighter purple-blue tones maintaining Catppuccin character
			},
			colors: {
				dark: {
				...
				light: {
					'main-background': '#5b5f7d', // lighter purple-gray, maintains Catppuccin's purple character
					...
					'main-text': '#eff1f5', // base (Latte) - very light for contrast
					'muted-text': '#dce0e8', // surface0 (Latte) - lighter muted
		...
		},
		{
			...
			previewColors: {
				...
				light: ['#4a5568', '#556270', '#6272a4', '#bd93f9', '#6272a4'] // lighter purple-gray tones maintaining Dracula's character
			},
			colors: {
				dark: {
				...
				light: {
					'main-background': '#4a5568', // lighter version maintaining purple-gray character
					...
					'primary-color': '#bd93f9', // purple (same vibrant purple)
					'primary-hover': '#c9a9ff', // lighter purple for hover
					'main-text': '#f8f8f2', // foreground (cream) - light text for contrast
					'muted-text': '#a0a0a0', // lighter muted text
					'reading-color': '#bd93f9' // purple (same)
				}
			}
		},
		{
			...
			previewColors: {
				...
				light: ['#665c54', '#7c6f64', '#928374', '#d65d0e', '#928374'] // lighter warm brown/gray tones maintaining Gruvbox character
			},
			colors: {
				dark: {
				...
				light: {
					'main-background': '#665c54', // lighter version maintaining warm brown character
					...
					'main-text': '#fbf1c7', // bg0 (light beige) - light text for contrast
					'muted-text': '#d5c4a1', // bg2 (lighter beige) - lighter muted
