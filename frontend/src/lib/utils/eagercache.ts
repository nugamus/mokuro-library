...
export function invalidateLibraryCache() {
	apiCache.invalidate('GET:/api/library');
}

export function invalidateStatsCache() {
	apiCache.invalidate('GET:/api/stats');
}

export function invalidateContributionsCache() {
	apiCache.invalidate('GET:/api/contributions');
}

export function invalidateSeriesCache(seriesId: string) {
	apiCache.invalidate(`GET:/api/library/series/${seriesId}`);
}

export function invalidateVolumeCache(volumeId: string) {
	apiCache.invalidate(`GET:/api/library/volume/${volumeId}`);
}
