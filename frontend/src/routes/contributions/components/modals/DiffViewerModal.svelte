		...
		>
			...
			<div class="p-4 bg-theme-surface/30 border-b border-theme-border flex gap-4 flex-shrink-0">
				<div class="flex items-center gap-2 text-xs">
					...
					<span class="px-2 py-1 rounded-lg bg-accent/20 text-accent font-bold">{volume.userPatchCount}</span>
				</div>
				<div class="flex items-center gap-2 text-xs">
					<span class="font-bold text-theme-secondary">Behind By:</span>
					<span class="px-2 py-1 rounded-lg bg-status-warning/20 text-status-warning font-bold">{volume.behindByCount}</span>
				</div>
